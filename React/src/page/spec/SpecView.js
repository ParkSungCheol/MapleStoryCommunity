    ...
    <>
      ...
      <div className="free-view-wrapper">
        ...
        <div id="freeview_btns">
          ...
          <button id="freeview_crud_btn" onClick={() => document.location.href = "http://localhost:3000/spec?" + urlparams}>목록</button>

          {(function() {
            if (userName === data.userid) return (<div> <button id="freeview_crud_btn" onClick={FreeDelete}>삭제</button>
            <button id="freeview_crud_btn" onClick={() => document.location.href = "http://localhost:3000/SpecUpdate/"+ no+"?"+urlparams}>수정</button></div>)

  ...
  return (
    <div id="create">
      ...
      <form> <br />
        ...
        <h3>내용</h3>
        <input type="textarea" id="content_input" name="ContentValue" value={ContentValue} onChange={onChangeContent} placeholder="내용 입력" />
        <div>
        ...
        <button id="list_btn" onClick={() => history.push("/free?" + urlparams[0])} >목록</button>

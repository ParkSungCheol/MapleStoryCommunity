  ...
  return (
    <>
      ...
      <div className="free-view-wrapper">
        ...
        <button id="freeview_crud_btn" onClick={() => document.location.href = "http://localhost:3000/raid?"+ urlparams}>목록</button>
   

        {(function() {
            if (userName === data.userid) return (<div> <button id="freeview_crud_btn" onClick={FreeDelete}>삭제</button>
            <button id="freeview_crud_btn" onClick={() => document.location.href = "http://localhost:3000/RaidUpdate/"+ no+"?"+urlparams}>수정</button></div>)

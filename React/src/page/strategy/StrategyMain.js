...
import { withRouter ,Link,Route,BrowserRouter , useRouteMatch} from 'react-router-dom';
...
//------------------------------------------------------------------
  return (
    <>
      ...
      <h2 align="center"></h2>
      <StrategyList /><br/><br/><br/>
      
      <div class="wirte_btn">
      {          (function() {
            if (userName != null) return (<div>  <Link to={"./StrategyCreate?"+urlparams} class="write_btn2">Write</Link></div>);
     ...
     <BrowserRouter>
     <Route exact path='/StrategyCreate : no' component={StrategyCreate} />
     </BrowserRouter>

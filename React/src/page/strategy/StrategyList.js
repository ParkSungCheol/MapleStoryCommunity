...
//------------------------------------------------------------------
  ...
  useEffect(() => {
    setDataList(array.filter((e) => e.set == true && e.bclass == "전략"));
  }, []);
        ...
        columns: [
          {
           ...
           Cell: e => <a href={`/StrategyView/${e.value[1]}`+"?"+urlparams}> {e.value[0]} </a>,
          },
        ],
      },
      {
